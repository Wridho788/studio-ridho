          ...
          <div className="grid md:grid-cols-2 gap-6">
            {services.map((service, index) => (
              <StaggerItem key={index}>
                <div className="group relative bg-white border-2 border-gray-100 rounded-2xl p-8 hover:border-[#FF8800]/30 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                  {/* Background Gradient on Hover */}
                  <div className="absolute inset-0 bg-gradient-to-br from-[#FF8800]/0 to-[#FF8800]/0 group-hover:from-[#FF8800]/5 group-hover:to-[#ff9933]/5 rounded-2xl transition-all duration-300" />
                  
                  <div className="relative">
                    <div className="text-4xl mb-4">{service.icon}</div>
                    <h3 className="text-xl font-bold text-[#191726] mb-3 group-hover:text-[#FF8800] transition-colors duration-300">
                      {service.title}
                    </h3>
                  ...
                  {/* Decorative Corner */}
                  <div className="absolute top-4 right-4 w-8 h-8 border-t-2 border-r-2 border-[#FF8800]/0 group-hover:border-[#FF8800]/30 rounded-tr-lg transition-all duration-300" />
                </div>
              </StaggerItem>
            ))}
          </div>
